...
class FL_LateCEConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.late_ce_region = str(late_ce_region)
    ...
    def backbone_kwargs(self) -> Dict[str, Any]:
        return {
            ...
            "late_ce_delta": self.late_ce_delta,
            "late_ce_alpha": self.late_ce_alpha,
            "late_ce_weight": self.late_ce_weight,
            "late_ce_region": self.late_ce_region,
        }


CONFIG_CLS = FL_LateCEConfig


@dataclass
class LateCESamplingConfig:
    """推理采样（末步 unembed；与训练 LateCE 无关）。"""
    ...
    @classmethod
    def from_dict(cls, cfg: dict) -> "LateCESamplingConfig":
