"""Frozen T5 encoder used as ODAR's continuous embedding source (training only)."""
...
def ensure_t5_encoder_cached(model_name: str = "t5-small") -> str:
    ...
    print(
        f"[odar] Local T5 encoder not found at {local_dir}; "
    ...
    print(f"[odar] T5 encoder ready at {local_dir}")
    return str(local_dir)
...
def encode_text(
    ...
    *,
    ...
    """Encode tokens and channel-normalize to the ODAR latent scale."""
