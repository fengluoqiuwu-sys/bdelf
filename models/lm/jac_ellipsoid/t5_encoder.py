"""JacEllipsoid T5 encoder facade: shared core with ``[jac_ellipsoid]`` log prefix."""
...
from models.lm.elf_core.t5_encoder import *  # noqa: F403
from models.lm.elf_core import t5_encoder as _core

_LOG_TAG = "jac_ellipsoid"
