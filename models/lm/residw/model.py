...
骨干与推理复用 ``models.lm.elf.model._ELFBackbone``。训练期 SC-CFG 把
...
from models.lm.residw.config import FL_ResidWConfig
from models.lm.residw.t5_encoder import ensure_t5_encoder_cached
