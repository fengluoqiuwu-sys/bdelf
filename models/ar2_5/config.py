"""AR2.5 configuration. Spec: temp/ar2_5.md."""
...
class FL_AR25Config(PretrainedConfig):
    """Configuration for AR2.5 (block-end generated anchor + bridge)."""
