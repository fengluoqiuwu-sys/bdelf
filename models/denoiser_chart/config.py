"""DenoiserChart 配置：ELF 双分支 + bottleneck 隔离 W_t + 中段冻 unembed CE。"""
...
class FL_DenoiserChartConfig(PretrainedConfig):
    """ELF 复制体：denoise 侧隔离通道预条件 W_t + 中段 L_chart。"""

    model_type = "fl_denoiser_chart"
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.chart_warp = bool(chart_warp)
    ...
    def backbone_kwargs(self) -> Dict[str, Any]:
        return {
            ...
            "chart_warp": self.chart_warp,
            "chart_weight": self.chart_weight,
            "chart_t_min": self.chart_t_min,
            "chart_t_max": self.chart_t_max,
            "chart_leak_decode": self.chart_leak_decode,
            "freeze_unembed": self.freeze_unembed,
        }


CONFIG_CLS = FL_DenoiserChartConfig


@dataclass
class DenoiserChartSamplingConfig:
    """推理采样（与训练期 W_t / L_chart 无关）。"""
    ...
    @classmethod
    def from_dict(cls, cfg: dict) -> "DenoiserChartSamplingConfig":
